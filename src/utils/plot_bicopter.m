function [] = plot_bicopter( ...
    ...
    export_csv(t_sol(1:end-1), elapsed_mampc, ...
        sprintf('results/bicopter/bicopter_elapsed_%d.csv', params.ls * index));
    export_csv(t_sol, x_sol(:, 1), ...
        sprintf('results/bicopter/bicopter_state0_%d.csv', params.ls * index));
    export_csv(t_sol, x_sol(:, 3), ...
        sprintf('results/bicopter/bicopter_state1_%d.csv', params.ls * index));
    export_csv(t_sol, x_sol(:, 5), ...
        sprintf('results/bicopter/bicopter_state2_%d.csv', params.ls * index));
    export_csv(t_sol(1:end-1), u_sol(:, 1), ...
        sprintf('results/bicopter/bicopter_input0_%d.csv', params.ls * index));
    export_csv(t_sol(1:end-1), u_sol(:, 2), ...
        sprintf('results/bicopter/bicopter_input1_%d.csv', params.ls * index));
%     exportgraphics(gcf, ...
